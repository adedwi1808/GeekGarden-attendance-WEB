...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $jumlah_pengajuan_lembur = Lembur::where("status_lembur", "Diajukan")->count();
        $jumlah_pengajuan_izin = Pengajuan_izin::where("status_izin", "Diajukan")->count();
        return view('Dashboard.index', compact('title','jumlah_pengajuan_izin', 'jumlah_pengaduan_absensi', 'jumlah_absensi', 'jumlah_pegawai', 'jumlah_pengajuan_lembur'));
    }
}
